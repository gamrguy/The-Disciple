...
public class LockedMedicine extends MetricsCard {
	public static final String ID = "LockedMedicine";
	...
	public void use(AbstractPlayer p, AbstractMonster m) {
    	AbstractDungeon.actionManager.addToBottom(new ChronoChannelAction(new UnlockedMedicine(this.upgraded)));
   	}

	@Override
	public AbstractCard makeCopy() {
		return new LockedMedicine();
	}
