...
public class LockedMawBank extends MetricsCard {
	public static final String ID = "LockedMawBank";
	...
	public LockedMawBank() {
		super(ID, NAME, "chrono_images/cards/LockedMawBank.png", COST, DESCRIPTION, AbstractCard.CardType.POWER,
	...
	public void use(AbstractPlayer p, AbstractMonster m) {
    	AbstractDungeon.actionManager.addToBottom(new ChronoChannelAction(new UnlockedMawBank(this.upgraded)));
   	}

	@Override
	public AbstractCard makeCopy() {
		return new LockedMawBank();
	}
