...
public class LockedThread extends MetricsCard {
	public static final String ID = "LockedThread";
	...
	public void use(AbstractPlayer p, AbstractMonster m) {
    	AbstractDungeon.actionManager.addToBottom(new ChronoChannelAction(new UnlockedThread(this.upgraded)));
   	}

	@Override
	public AbstractCard makeCopy() {
		return new LockedThread();
	}
