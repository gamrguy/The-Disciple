...
public class LockedTurtyl extends MetricsCard {
	public static final String ID = "LockedTurtyl";
	...
	public LockedTurtyl() {
		super(ID, NAME, "chrono_images/cards/LockedTurtyl.png", COST, DESCRIPTION, AbstractCard.CardType.POWER,
	...
	public void use(AbstractPlayer p, AbstractMonster m) {
    	AbstractDungeon.actionManager.addToBottom(new ChronoChannelAction(new UnlockedTurtyl(this.upgraded)));
   	}

	@Override
	public AbstractCard makeCopy() {
		return new LockedTurtyl();
	}
