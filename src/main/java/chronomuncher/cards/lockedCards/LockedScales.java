...
public class LockedScales extends MetricsCard {
	public static final String ID = "LockedScales";
	...
	public LockedScales() {
		super(ID, NAME, "chrono_images/cards/LockedScales.png", COST, DESCRIPTION, AbstractCard.CardType.POWER,
	...
	public void use(AbstractPlayer p, AbstractMonster m) {
    	AbstractDungeon.actionManager.addToBottom(new ChronoChannelAction(new UnlockedScales(this.upgraded)));
   	}

	@Override
	public AbstractCard makeCopy() {
		return new LockedScales();
	}
