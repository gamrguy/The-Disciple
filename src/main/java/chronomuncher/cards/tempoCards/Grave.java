...
public class Grave extends MetricsCard {
	public static final String ID = "Grave";
	...
	public Grave() {
		super(ID, NAME, "chrono_images/cards/Grave.png", COST, DESCRIPTION, AbstractCard.CardType.SKILL,
