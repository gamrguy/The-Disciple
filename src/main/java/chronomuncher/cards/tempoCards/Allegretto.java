...
public class Allegretto extends MetricsCard {
	public static final String ID = "Allegretto";
	...
	public Allegretto() {
		super(ID, NAME, "chrono_images/cards/Allegretto.png", COST, DESCRIPTION, AbstractCard.CardType.ATTACK,
